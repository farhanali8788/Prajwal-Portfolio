...
export default function Skills() {
  return (
    <section
      id="skills"
      className="relative border-t border-line/60 py-24 md:py-36"
    >
      <div className="shell">
        <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
          ...
          <Reveal dir="up" delay={0.1}>
            <p className="max-w-xs text-sm leading-relaxed text-muted md:text-right">
              Equal parts craft and software — the tools behind every frame and
              cut.
            </p>
          </Reveal>
        </div>
            ...
            return (
              <Reveal key={s.name} dir="up" delay={(i % 4) * 0.06}>
                ...
                >
                  ...
                  <p className="mt-5 font-display text-xl uppercase leading-none tracking-wide text-ink">
                    {s.name}
                  </p>
